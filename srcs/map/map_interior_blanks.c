...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   map_interior_blanks.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: knamba <knamba@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/16 13:27:28 by knamba            #+#    #+#             */
/*   Updated: 2025/02/16 13:55:44 by knamba           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/cub3d.h"

static void	flood_fill(int row, int col, t_vars *vars)
{
	int	dirs[4][2];
	int	i;
...
static void	flood_fill_outside(t_vars *vars)
{
	int	i;
