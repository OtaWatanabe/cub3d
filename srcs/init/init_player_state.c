...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/16 13:21:47 by knamba            #+#    #+#             */
/*   Updated: 2025/02/16 13:22:10 by knamba           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 北向き(上向き)
static void	player_north_direction(t_vars *vars, int x, int y)
{
...
// 南向き(下向き)
static void	player_south_direction(t_vars *vars, int x, int y)
{
	vars->player.pos_x = x + 0.5;
	vars->player.pos_y = y + 0.5;
	vars->player.dir_x = 0.0;
...
// 東向き(右向き)
static void	player_east_direction(t_vars *vars, int x, int y)
{
	vars->player.pos_x = x + 0.5;
	vars->player.pos_y = y + 0.5;
	vars->player.dir_x = 1.0;
	vars->player.dir_y = 0.0;
...
// 西向き(左向き)
static void	player_west_direction(t_vars *vars, int x, int y)
{
	vars->player.pos_x = x + 0.5;
	vars->player.pos_y = y + 0.5;
	vars->player.dir_x = -1.0;
